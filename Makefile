...
# APP_TITLE / APP_DESCRIPTION / APP_AUTHOR are stored in the SMDH file (Optional)
# ICON is the filename of the icon (.png), relative to the project folder (Optional)
#---------------------------------------------------------------------------------
...
APP_TITLE		:=	Stereo Cube 3D
APP_DESCRIPTION	:=	Cube stereoscopique citro3d
APP_AUTHOR		:=	Fadgiras
...
# Outils tiers pour la generation du CIA (a placer dans devkitPro/tools/bin)
MAKEROM		?=	makerom
